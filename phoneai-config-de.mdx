...
Du kannst Weiterleitungen themenbezogen an verschiedene Nummern einrichten lassen. Da dies auch Training der KI bedeutet, wird diese Konfiguration von unserem Customer Success Team eingerichtet ([support@dialogshift.com](mailto:support@dialogshift.com)).
